//Utilizando massa de dados: ex: uso simultaneo de vários usuários fazendo login
//Criar o arquivo usuarios.json dentro da pasta fixtures
...
describe('Página de cadastro', () => {
    ...
    //requisição para o endereço do arquivo
